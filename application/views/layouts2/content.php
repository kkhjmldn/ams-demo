                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tasks" role="tabpanel" aria-labelledby="tasks-tab" data-filter-list="card-list-body">
                                    ...
                                    <div class="content-list-body">
                                        <div class="card-list">
                                            ...
                                            <div class="card-list-body filter-list-1540358989534"><div class="card card-task">
                                                    <div class="progress">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="card-meta">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <a href="#" data-toggle="tooltip" title="" data-original-title="David">
                                                                        <img alt="David Whittaker" class="avatar" src="assets/img/avatar-male-4.jpg">
                                                                    </a>
                                                                </li>
                                        ...
                                        <div class="card-list">
                                            ...
                                            <div class="card-list-body filter-list-1540358989535"><div class="card card-task">
                                                    <div class="progress">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="card-title">
                                                            <a href="#">
                                                                <h6 data-filter-by="text" class="H6-filter-by-text">Create brand mood boards</h6>
                                                            </a>
                                                        ...
                                                        <div class="card-meta">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <a href="#" data-toggle="tooltip" title="" data-original-title="Claire">
                                                                        <img alt="Claire Connors" class="avatar" src="assets/img/avatar-female-1.jpg">
                                                                    </a>
                                                                </li>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="card-title">
                                                            <a href="#">
                                                                <h6 data-filter-by="text" class="H6-filter-by-text">Produce broad concept directions</h6>
                                                            </a>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="card-title">
                                                            <a href="#">
                                                                <h6 data-filter-by="text" class="H6-filter-by-text">Present concepts and establish direction</h6>
                                                            </a>
                                        ...
                                        <div class="card-list">
                                            ...
                                            <div class="card-list-body filter-list-1540358989536"><div class="card card-task">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-success" role="progressbar" style="width: 0%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="card-title">
                                                            <a href="#">
                                                                <h6 data-filter-by="text" class="H6-filter-by-text">Produce realised brand package</h6>
                                                            </a>
                                    ...
                                    <div class="content-list">
                                        ...
                                        <div class="content-list-body row">
                                            <div class="col">
                                                ...
                                                <ul class="list-group list-group-activity dropzone-previews flex-column-reverse filter-list-1540358989531"><li class="list-group-item" data-t="null" data-i="null" data-l="null" data-e="null">
                                                        <div class="media align-items-center">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <img alt="Peggy Brown" src="assets/img/avatar-female-2.jpg" class="avatar filter-by-data-title" data-title="Peggy Brown" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                        ...
                                                        <div class="media align-items-center">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <img alt="Harry Xai" src="assets/img/avatar-male-2.jpg" class="avatar filter-by-data-title" data-title="Harry Xai" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                        ...
                                                        <div class="media align-items-center">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <img alt="Ravi Singh" src="assets/img/avatar-male-3.jpg" class="avatar filter-by-data-title" data-title="Ravi Singh" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                        ...
                                                        <div class="media align-items-center">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <img alt="Claire Connors" src="assets/img/avatar-female-1.jpg" class="avatar filter-by-data-title" data-title="Claire Connors" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                                        ...
                                                        <div class="media align-items-center">
                                                            <ul class="avatars">
                                                                ...
                                                                <li>
                                                                    <img alt="David Whittaker" src="assets/img/avatar-male-4.jpg" class="avatar filter-by-data-title" data-title="David Whittaker" data-toggle="tooltip" data-filter-by="data-title">
                                                                </li>
                                                            </ul>
                                                            <div class="media-body d-flex justify-content-between align-items-center">
                                                                <div>
                                ...
                                <div class="tab-pane fade" id="activity" role="tabpanel" aria-labelledby="activity-tab" data-filter-list="list-group-activity">
                                    <div class="content-list">
                                        ...
                                        <!--end of content list head-->
                                        <div class="content-list-body">
                                            <ol class="list-group list-group-activity filter-list-1540358989522"><li class="list-group-item">
                                                    <div class="media align-items-center">
                                                        <ul class="avatars">
                                                            <li>
                                                                <div class="avatar bg-primary">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="users-manage" data-filter-list="form-group-users">
                                                ...
                                                <div class="form-group-users filter-list-1540358989519"><div class="custom-control custom-checkbox">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade" id="project-edit-members" role="tabpanel" aria-labelledby="project-edit-members-tab">
                                                    <div class="users-manage" data-filter-list="form-group-users">
                                                        ...
                                                        <div class="form-group-users filter-list-1540358989516"><div class="custom-control custom-checkbox">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade" id="task-add-members" role="tabpanel" aria-labelledby="task-add-members-tab">
                                                    <div class="users-manage" data-filter-list="form-group-users">
                                                        ...
                                                        <div class="form-group-users filter-list-1540358989511"><div class="custom-control custom-checkbox">
